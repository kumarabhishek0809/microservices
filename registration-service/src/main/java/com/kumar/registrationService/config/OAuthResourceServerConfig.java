...
public class OAuthResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    private static final String SECURED_PATTERN_WRITE = "/registration/**";

    private static final String SECURED_PATTERN_READ = "/registration/**";

    @Override
    public void configure(HttpSecurity http) throws Exception {
        http.requestMatchers()
                .antMatchers(SECURED_PATTERN_WRITE).and()
                .authorizeRequests()
